...
const config = {
  ...
  premiumUrl: parseUrl(process.env.PREMIUM_URL, 'https://www.winible.com/theboardroomvip'),
  ...
  channels: {
    ...
    freePremium: process.env.FREE_PREMIUM_CHANNEL_ID || '1538313195788173313',
    chatRoom: process.env.CHAT_ROOM_CHANNEL_ID || '1538313210505990225',
    wins: process.env.WINS_CHANNEL_ID || '1538313213786202114',
    boardroomPicks: process.env.BOARDROOM_PICKS_CHANNEL_ID || '1538313205531811854',
    freePicks: process.env.FREE_PICKS_CHANNEL_ID || '1538313207717040188',
  },
  ...
  links: {
    ...
    season: parseUrl(process.env.NFL_SEASON_URL, 'https://www.winible.com/checkout/1611810856515948636?pid=1611810856532725853'),
  },
  picks: {
